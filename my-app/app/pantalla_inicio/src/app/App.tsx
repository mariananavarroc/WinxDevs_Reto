...
function ChatHead() {
  ...
  return (
    <>
            ...
            <div className="bg-white rounded-2xl rounded-br-sm shadow-xl border border-gray-100 p-3.5 relative" style={{ boxShadow: "0 8px 32px rgba(0,0,0,0.14)" }}>
              ...
              <div className="flex items-center gap-2 mb-2.5 pr-5">
                <div className="w-7 h-7 rounded-full overflow-hidden border-2 border-green-200 shrink-0">
                  <img src={viejitoImg} alt="Asesor" className="w-full h-full object-cover" />
                </div>
                <div>
      ...
      >
        <img src={viejitoImg} alt="Asesor de crecimiento" className="w-full h-full object-cover" />
      </motion.button>
    </>
  );
}
...
export default function App() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-300">
      <div className="relative w-[390px] h-[844px] bg-gray-50 rounded-[40px] overflow-hidden flex flex-col" style={{ boxShadow: "0 8px 40px 0 rgba(0,0,0,0.13)", border: "1.5px solid rgba(0,0,0,0.08)" }}>
